...
{
    class organizador : jogador
    {
        public string id;
        public double taxa_de_inscricao;
        public double preco_do_ingresso;
        public string email;
        ...
        public override void cadastrarDados()
        {
            ...
            Console.Write("taxa de inscrição= ");
            this.taxa_de_inscricao = double.Parse(Console.ReadLine());
            Console.Clear();
        }
